      ...
      () => Row(
        children: [
          _ComposerIconButton(
            ...
            onPressed: model.isUploading.value ? null : model.pickAndSendFile,
          ),
          const SizedBox(width: 6),
          _ComposerIconButton(
            icon: Icons.photo_camera_rounded,
            onPressed: model.isUploading.value ? null : model.pickAndSendPhoto,
          ),
          const SizedBox(width: 6),
          _ComposerIconButton(
            icon: Icons.mic_rounded,
            onPressed:
                model.isUploading.value ? null : model.startVoiceRecording,
          ),
          const SizedBox(width: 6),
          _ComposerIconButton(
            icon: Icons.location_on_rounded,
            onPressed:
                model.isUploading.value ? null : model.sendCurrentLocation,
          ),
          ...
          const SizedBox(width: 8),
          _SendButton(
            isLoading: model.isUploading.value,
            onPressed: model.isUploading.value
                ? null
                : () {
      ...
      () => Row(
        children: [
          _ComposerIconButton(
            ...
            onPressed:
                model.isUploading.value ? null : model.cancelVoiceRecording,
          ),
          const SizedBox(width: 8),
          Expanded(
            child: Container(
          ...
          _SendButton(
            isLoading: model.isUploading.value,
            onPressed:
                model.isUploading.value ? null : model.sendVoiceRecording,
          ),
        ],
      ),
    );
