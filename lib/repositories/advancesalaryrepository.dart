...
class AdvanceSalaryRepository {
  ...
  Future<AdavanceSalaryCreateResponse> approveAdvanceSalary({
    required String id,
    required String releasedAmount,
    String? remark,
  }) async {
    Preferences preferences = Preferences();
    String token = await preferences.getToken();
    ...
    try {
      final response = await Connect().postResponse(
        Constant.ADVANCE_SALARY_APPROVE_URL,
        headers,
        {
          "advance_salary_id": id,
  ...
  Future<AdavanceSalaryCreateResponse> rejectAdvanceSalary({
    required String id,
    String? remark,
  }) async {
    Preferences preferences = Preferences();
    ...
    try {
      final response = await Connect().postResponse(
        Constant.ADVANCE_SALARY_REJECT_URL,
        headers,
        {
          "advance_salary_id": id,
          "remark": remark ?? "",
